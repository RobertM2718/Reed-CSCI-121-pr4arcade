...
class Agent:
    ...
    def __init__(self,position,world): 
        ...
        self.world    = world 
        self.world.add(self) #This will cause a lot of errors in PlayAsteroids.  Check there before making the change.  
        self.ticks    = 0
...
class Game(Frame):
    ...
    def add(self, agent): #both
        self.agents.append(agent)

    def remove(self, agent): #both
    ...
    def draw_shape(self, shape, color): #client
    ...
    def window_to_world(self,x,y): #client
